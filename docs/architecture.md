...
- `report/service.go` (data loading, LIMIT 1000 events / 500 tasks) + `report/pdf_builder.go` (3-page PDF: summary cards, timeline, tasks+docs) + `report/logo.go` (go:embed logo for PDF header)
