...
- **i18n PWA** : hook `useI18n(dict)` dans `lib/i18n.ts` + dictionnaires EN/FR/DE dans `lib/translations.ts`. **Toutes les pages traduites** : dashboard, vehicles, bays, tasks, profile, scan (+ sheets), audit, vehicle detail, vehicle new/edit, vehicle move/task/photo/exit, bay new/edit/detail, qr-codes, admin/qr-codes, users, DesktopTopBar, SideNav, BottomNav, ActivityFeed, CreateTaskModal, login, change-password. Dicts : `dashboardI18n`, `baysI18n`, `tasksI18n`, `profileI18n`, `scanI18n`, `activityI18n`, `auditI18n`, `navI18n`, `pageLabelsI18n`, `commonI18n`, `vehicleDetailI18n`, `vehicleFormI18n`, `vehicleMoveI18n`, `vehicleTaskI18n`, `vehiclePhotoI18n`, `vehicleExitI18n`, `createTaskModalI18n`, `bayFormI18n`, `bayDetailI18n`, `qrCodesI18n`. Login/change-password utilisent leurs propres dicts locaux
